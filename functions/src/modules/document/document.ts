...
export class Document extends Base {
    ...
    */
    async get(documentID: string, collectionName?: string): Promise<any> {
        ...
        if (!documentID) return this.error(E.NO_DOCUMENT_ID, { documentID: documentID }); // document id is empty.
    ...
    */
    async delete(documentID): Promise<any> {
        if (!documentID) return this.error(E.NO_DOCUMENT_ID, { documentID: documentID });
